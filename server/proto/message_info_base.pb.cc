...
void protobuf_AssignDesc_message_5finfo_5fbase_2eproto() {
  ...
  static const int MessageInfoBase_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageInfoBase, publisher_time_),
...
const int MessageInfoBase::kPublisherTimeFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_publisher_time;
        break;
      }
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_publisher_time:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, &publisher_time_)));
...
void MessageInfoBase::SerializeWithCachedSizes(
  ...
  // optional uint32 publisher_time = 4;
  if (has_publisher_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->publisher_time(), output);
  }
...
::google::protobuf::uint8* MessageInfoBase::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 publisher_time = 4;
  if (has_publisher_time()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->publisher_time(), target);
  }
...
void MessageInfoBase::MergeFrom(const MessageInfoBase& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_publisher_time()) {
      set_publisher_time(from.publisher_time());
    }
    if (from.has_content()) {
...
void MessageInfoBase::Swap(MessageInfoBase* other) {
  if (other != this) {
    ...
    std::swap(publisher_time_, other->publisher_time_);
