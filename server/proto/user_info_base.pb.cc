...
void protobuf_AssignDesc_user_5finfo_5fbase_2eproto() {
  ...
  static const int UserInfoBase_offsets_[12] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UserInfoBase, db_flag_),
  };
...
const int UserInfoBase::kDbFlagFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 11: {
        ...
        if (input->ExpectTag(96)) goto parse_db_flag;
        break;
      }
...
void UserInfoBase::SerializeWithCachedSizes(
  ...
  // optional uint32 db_flag = 12;
  if (has_db_flag()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(12, this->db_flag(), output);
  }
...
::google::protobuf::uint8* UserInfoBase::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 db_flag = 12;
  if (has_db_flag()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(12, this->db_flag(), target);
  }
...
void UserInfoBase::Swap(UserInfoBase* other) {
  if (other != this) {
    ...
    std::swap(db_flag_, other->db_flag_);
