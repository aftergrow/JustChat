...
void protobuf_AssignDesc_relation_5finfo_5fbase_2eproto() {
  ...
  static const int RelationInfoBase_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RelationInfoBase, friend_count_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RelationInfoBase, black_count_),
  };
...
void protobuf_AddDesc_relation_5finfo_5fbase_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\030relation_info_base.proto\022\003ssp\"\204\001\n\020Rela"
    "tionInfoBase\022\013\n\003ver\030\001 \001(\r\022\017\n\007user_id\030\002 \001"
    "(\r\022\023\n\013friend_list\030\003 \003(\r\022\022\n\nblack_list\030\004 "
    "\003(\r\022\024\n\014friend_count\030\005 \001(\r\022\023\n\013black_count"
    "\030\006 \001(\r", 166);
...
const int RelationInfoBase::kFriendCountFieldNumber;
const int RelationInfoBase::kBlackCountFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(32)) goto parse_black_list;
        if (input->ExpectTag(40)) goto parse_friend_count;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_black_count;
        break;
      }
...
void RelationInfoBase::SerializeWithCachedSizes(
  ...
  // optional uint32 friend_count = 5;
  if (has_friend_count()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(5, this->friend_count(), output);
  }

  // optional uint32 black_count = 6;
  if (has_black_count()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(6, this->black_count(), output);
  }
...
::google::protobuf::uint8* RelationInfoBase::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 friend_count = 5;
  if (has_friend_count()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(5, this->friend_count(), target);
  }

  // optional uint32 black_count = 6;
  if (has_black_count()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(6, this->black_count(), target);
  }
...
void RelationInfoBase::MergeFrom(const RelationInfoBase& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_black_count()) {
      set_black_count(from.black_count());
    }
  }
...
void RelationInfoBase::Swap(RelationInfoBase* other) {
  if (other != this) {
    ...
    std::swap(black_count_, other->black_count_);
