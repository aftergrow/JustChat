...
class MessageInfoBase : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 publisher_time = 4;
  inline bool has_publisher_time() const;
  inline void clear_publisher_time();
  static const int kPublisherTimeFieldNumber = 4;
  inline ::google::protobuf::uint32 publisher_time() const;
  inline void set_publisher_time(::google::protobuf::uint32 value);
 ...
 private:
  ...
  inline void set_has_publisher_time();
  inline void clear_has_publisher_time();
  ...
  ::google::protobuf::uint32 publisher_time_;
  ::std::string* content_;
...
inline ::google::protobuf::uint32 MessageInfoBase::user_id() const {
  return user_id_;
}
inline void MessageInfoBase::set_user_id(::google::protobuf::uint32 value) {
  set_has_user_id();
  user_id_ = value;
}
...
inline void MessageInfoBase::set_has_publisher_time() {
  _has_bits_[0] |= 0x00000008u;
}
inline void MessageInfoBase::clear_has_publisher_time() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void MessageInfoBase::clear_publisher_time() {
  publisher_time_ = 0u;
  clear_has_publisher_time();
}
inline ::google::protobuf::uint32 MessageInfoBase::publisher_time() const {
  return publisher_time_;
}
inline void MessageInfoBase::set_publisher_time(::google::protobuf::uint32 value) {
  set_has_publisher_time();
