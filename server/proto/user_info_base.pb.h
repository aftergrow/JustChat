...
class UserInfoBase : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_db_flag() const;
  inline void clear_db_flag();
  static const int kDbFlagFieldNumber = 12;
  inline ::google::protobuf::uint32 db_flag() const;
  inline void set_db_flag(::google::protobuf::uint32 value);
 ...
 private:
  ...
  inline void set_has_db_flag();
  inline void clear_has_db_flag();
  ...
  ::google::protobuf::uint32 db_flag_;
...
inline void UserInfoBase::set_has_db_flag() {
  _has_bits_[0] |= 0x00000800u;
}
inline void UserInfoBase::clear_has_db_flag() {
  _has_bits_[0] &= ~0x00000800u;
}
...
inline ::google::protobuf::uint32 UserInfoBase::db_flag() const {
  return db_flag_;
}
inline void UserInfoBase::set_db_flag(::google::protobuf::uint32 value) {
  set_has_db_flag();
  db_flag_ = value;
}
